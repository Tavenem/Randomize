...
/// <summary>
/// Produces pseudo-random numbers in a log-normal distribution.
/// </summary>
public static class LogNormalDistribution
{
    ...
    private static (double z0, double z1) Generate(
        ...
        double sigma)
    {
        ...
        return (Math.Exp((u * factor) + mu), Math.Exp((v * factor) + mu));
    }
}
