...
namespace Tavenem.Randomize
{
    ...
    public class Rehydrator
    {
        ...
        /// is <see langword="null"/> or contains no elements.
        /// </returns>
        public int NextIndex<T>(ulong index, IList<T>? list, Func<T, double> weightFunction)
            => (list?.Count ?? 0) == 0
                ? -1
        ...
        public HugeNumber NextNumber(ulong index) => SetIndex(index).NextNumber();
        ...
        /// name="maxValue"/>.</returns>
        public HugeNumber NextNumber(ulong index, HugeNumber maxValue) => SetIndex(index).NextNumber(maxValue);
        ...
        /// is determined by <see cref="RandomizeOptions.InvalidFloatingRangeResult"/>.
        /// </remarks>
        public HugeNumber NextNumber(ulong index, HugeNumber minValue, HugeNumber maxValue) => SetIndex(index).NextNumber(minValue, maxValue);

        /// <summary>
        /// Gets a random, normalized quaternion whose components are <see cref="decimal"/> values.
        /// </summary>
        /// <param name="index">The 0-based index of the random value to retrieve.</param>
        /// <returns>A random, normalized quaternion whose components are <see cref="decimal"/>
        /// values.</returns>
        /// <remarks>
        ...
        /// </remarks>
        public Mathematics.Decimals.Quaternion NextQuaternionDecimal(ulong index)
        {
            var randomizer = GetRandomizer(index);
            return new Mathematics.Decimals.Quaternion(
        ...
        /// considered to be inconsequential.
        /// </remarks>
        public Mathematics.Doubles.Quaternion NextQuaternionDouble(ulong index)
        {
            var randomizer = GetRandomizer(index);
            return new Mathematics.Doubles.Quaternion(
        ...
        /// <summary>
        /// Gets a random, normalized quaternion whose components are <see cref="HugeNumber"/>
        /// values.
        /// </summary>
        /// <param name="index">The 0-based index of the random value to retrieve.</param>
        /// <returns>A random, normalized quaternion whose components are <see
        /// cref="HugeNumber"/> values.</returns>
        /// <remarks>
        /// Each component is selected randomly as a value between 0 and 1, then the result is
        /// normalized. This may cause some form of quasi-Gaussian distribution of results, as the
        /// result is a composite of four independently determined variables, but the
        ...
        /// considered to be inconsequential.
        /// </remarks>
        public Mathematics.HugeNumbers.Quaternion NextQuaternionNumber(ulong index)
        {
            var randomizer = GetRandomizer(index);
            return new Mathematics.HugeNumbers.Quaternion(
        ...
        /// name="maxLength"/>, and whose components are <see cref="decimal"/> values.
        /// </summary>
        /// <param name="index">The 0-based index of the random value to retrieve.</param>
        ...
        /// name="maxLength"/>, and whose components are <see cref="decimal"/> values.</returns>
        /// <remarks>
        /// A random rotation is generated with <see cref="Randomizer.NextQuaternionDecimal()"/>,
        ...
        /// </remarks>
        public Mathematics.Decimals.Vector3 NextVector3Decimal(ulong index, decimal maxLength)
        {
            var randomizer = GetRandomizer(index);
            return Mathematics.Decimals.Vector3.UnitX.Transform(randomizer.NextQuaternionDecimal()) * randomizer.NextDecimal(maxLength);
        }

        /// <summary>
        /// Gets a randomly oriented vector whose length is between <paramref name="minLength"/> and
        /// <paramref name="maxLength"/>, and whose components are <see cref="decimal"/> values.
        /// </summary>
        /// <param name="index">The 0-based index of the random value to retrieve.</param>
        ...
        /// and <paramref name="maxLength"/>, and whose components are <see cref="decimal"/>
        /// values.</returns>
        /// <remarks>
        /// <para>
        /// A random rotation is generated with <see cref="Randomizer.NextQuaternionDecimal()"/>,
        ...
        /// </para>
        /// </remarks>
        public Mathematics.Decimals.Vector3 NextVector3Decimal(ulong index, decimal minLength, decimal maxLength)
        {
            var randomizer = GetRandomizer(index);
            return Mathematics.Decimals.Vector3.UnitX.Transform(randomizer.NextQuaternionDecimal()) * randomizer.NextDecimal(minLength, maxLength);
        }
        ...
        /// the vector components were generated independently.
        /// </remarks>
        public Mathematics.Doubles.Vector3 NextVector3Double(ulong index, double maxLength)
        {
            var randomizer = GetRandomizer(index);
            return Mathematics.Doubles.Vector3.UnitX.Transform(randomizer.NextQuaternionDouble()) * randomizer.NextDouble(maxLength);
        }
        ...
        /// </para>
        /// </remarks>
        public Mathematics.Doubles.Vector3 NextVector3Double(ulong index, double minLength, double maxLength)
        {
            var randomizer = GetRandomizer(index);
            return Mathematics.Doubles.Vector3.UnitX.Transform(randomizer.NextQuaternionDouble()) * randomizer.NextDouble(minLength, maxLength);
        }

        /// <summary>
        /// Gets a randomly oriented vector whose length is between 0 and <paramref
        /// name="maxLength"/>, and whose components are <see cref="HugeNumber"/> values.
        /// </summary>
        /// <param name="index">The 0-based index of the random value to retrieve.</param>
        /// <param name="maxLength">
        /// <para>
        ...
        /// </para>
        /// <para>
        /// <see cref="HugeNumber.PositiveInfinity"/> will always result in an infinite-length vector.
        /// </para>
        /// </param>
        /// <returns>A randomly oriented vector whose length is between 0 and <paramref
        /// name="maxLength"/>, and whose components are <see cref="HugeNumber"/> values.</returns>
        /// <remarks>
        /// A random rotation is generated with <see cref="Randomizer.NextQuaternionNumber()"/>,
        /// then the vector is scaled randomly according to <paramref name="maxLength"/>, to avoid
        /// unintentionally generating lengths in a quasi-Gaussian distribution, as would occur if
        /// the vector components were generated independently.
        /// </remarks>
        public Mathematics.HugeNumbers.Vector3 NextVector3Number(ulong index, HugeNumber maxLength)
        {
            var randomizer = GetRandomizer(index);
            return Mathematics.HugeNumbers.Vector3.UnitX.Transform(randomizer.NextQuaternionNumber()) * randomizer.NextNumber(maxLength);
        }

        /// <summary>
        /// Gets a randomly oriented vector whose length is between <paramref name="minLength"/> and
        /// <paramref name="maxLength"/>, and whose components are <see cref="HugeNumber"/> values.
        /// </summary>
        /// <param name="index">The 0-based index of the random value to retrieve.</param>
        /// <param name="minLength">The inclusive lower bound of the length of the vector to be
        /// generated.</param>
        ...
        /// </param>
        /// <returns>A randomly oriented vector whose length is between <paramref name="minLength"/>
        /// and <paramref name="maxLength"/>, and whose components are <see cref="HugeNumber"/>
        /// values.</returns>
        /// <remarks>
        /// <para>
        /// A random rotation is generated with <see cref="Randomizer.NextQuaternionNumber()"/>,
        ...
        /// </para>
        /// </remarks>
        public Mathematics.HugeNumbers.Vector3 NextVector3Number(ulong index, HugeNumber minLength, HugeNumber maxLength)
        {
            var randomizer = GetRandomizer(index);
            return Mathematics.HugeNumbers.Vector3.UnitX.Transform(randomizer.NextQuaternionNumber()) * randomizer.NextNumber(minLength, maxLength);
        }
