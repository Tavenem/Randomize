...
namespace Tavenem.Randomize.Generators
{
    ...
    public class RandomNumberGenerator
    {
        ...
        /// <summary>
        /// Gets a random, nonnegative <see cref="HugeNumber"/> less than 1.
        /// </summary>
        /// <returns>A random, nonnegative <see cref="HugeNumber"/> less than 1.</returns>
        public HugeNumber NextNumber() => _generator.NextNumber();

        /// <summary>
        /// Gets a random <see cref="HugeNumber"/> between zero and <paramref name="maxValue"/>.
        /// </summary>
        /// <param name="maxValue">
        /// <para>
        /// The exclusive maximum bound of the random number to be generated.
        ...
        /// </para>
        /// <para>
        /// If the value is <see cref="HugeNumber.NaN"/> the result will also be <see
        /// cref="HugeNumber.NaN"/>.
        /// </para>
        /// <para>
        /// If the value is positive or negative infinity, it will always be returned as the result.
        /// </para>
        /// </param>
        /// <returns>A random, nonnegative <see cref="HugeNumber"/> less than <paramref
        /// name="maxValue"/>.</returns>
        public HugeNumber NextNumber(HugeNumber maxValue)
        {
            if (maxValue.IsNaN)
            {
            ...
            return NextNumber() * maxValue;
        }

        /// <summary>
        /// Gets a random <see cref="HugeNumber"/> greater than or equal to <paramref name="minValue"/>
        /// and less than or equal to <paramref name="maxValue"/>.
        /// </summary>
        /// <param name="minValue">
        /// <para>
        ...
        /// </para>
        /// </param>
        /// <returns>A random, nonnegative <see cref="HugeNumber"/> greater than or equal to <paramref
        /// name="minValue"/> and less than <paramref name="maxValue"/>.</returns>
        /// <remarks>
        /// If <paramref name="minValue"/> is greater than <paramref name="maxValue"/>, the result
        /// is determined by <see cref="RandomizeOptions.InvalidFloatingRangeResult"/>.
        /// </remarks>
        public HugeNumber NextNumber(HugeNumber minValue, HugeNumber maxValue)
        {
            if (minValue.IsNaN
                || maxValue.IsNaN)
            {
            ...
            if (minValue.IsInfinite)
            {
                if (maxValue.IsInfinite)
                {
                    if (HugeNumber.Sign(minValue) == HugeNumber.Sign(maxValue))
                    {
                        return minValue;
                    }
                    else
