...
namespace Tavenem.Randomize.Generators
{
    ...
    public sealed class MersenneTwister : IGenerator
    {
        ...
        /// <summary>
        /// A value which produces a <see cref="HugeNumber"/> between 0 (inclusive) and 1 (exclusive)
        /// when multiplied by a non-negative <see cref="int"/>.
        /// </summary>
        private static readonly HugeNumber _IntToNumberMultiplier = 1 / (new HugeNumber(int.MaxValue, 0) + 1);
        ...
        public HugeNumber NextNumber()
        {
            ...
            return (int)((y ^ (y >> 18)) >> 1) * _IntToNumberMultiplier;
        }
