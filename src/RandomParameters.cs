...
namespace Tavenem.Randomize
{
    ...
    public struct RandomParameters : IEquatable<RandomParameters>, ISerializable
    {
        /// <summary>
        ...
        private RandomParameters(SerializationInfo info, StreamingContext context) : this(
            (DistributionType?)info.GetValue(nameof(DistributionType), typeof(DistributionType)) ?? DistributionType.ContinuousUniform,
            (double?)info.GetValue(nameof(Minimum), typeof(double?)),
            (double?)info.GetValue(nameof(Maximum), typeof(double?)),
            (double[]?)info.GetValue(nameof(Parameters), typeof(double[])),
            (byte?)info.GetValue(nameof(Precision), typeof(byte?)))
        { }
        ...
        /// cref="Mathematics.DoubleConstants.NearlyZero"/>).
        /// </para>
        /// </param>
        /// <param name="precision">The number of decimal places to which non-integral values should
        /// be rounded.</param>
        ...
        public static RandomParameters Parse(string? s)
        {
            if (string.IsNullOrWhiteSpace(s))
            {
                throw new FormatException();
            }
            if (TryParse(s.AsSpan(), CultureInfo.CurrentCulture, out var result))
            {
                return result;
            }
            throw new FormatException();
        ...
        /// space, contains invalid <see cref="RandomParameters"/> data, or the format cannot be
        /// determined.</exception>
        public static RandomParameters Parse(in ReadOnlySpan<char> s)
        {
            if (s.IsEmpty || s.IsWhiteSpace())
            {
                throw new FormatException();
            }
            if (TryParse(s, CultureInfo.CurrentCulture, out var result))
            {
                return result;
            }
            throw new FormatException();
        ...
        /// space, contains invalid <see cref="RandomParameters"/> data, or the format cannot be
        /// determined.</exception>
        public static RandomParameters Parse(string? s, IFormatProvider provider)
        {
            if (string.IsNullOrWhiteSpace(s))
            {
                throw new FormatException();
        ...
        /// space, contains invalid <see cref="RandomParameters"/> data, or the format cannot be
        /// determined.</exception>
        public static RandomParameters Parse(in ReadOnlySpan<char> s, IFormatProvider provider)
        {
            if (s.IsEmpty || s.IsWhiteSpace())
            {
                throw new FormatException();
        ...
        /// determined.</exception>
        public static RandomParameters ParseExact(string? s, string? format)
        {
            if (string.IsNullOrWhiteSpace(s))
            {
                throw new FormatException();
            }
            if (TryParseExact(s.AsSpan(), format, CultureInfo.CurrentCulture, out var result))
            {
                return result;
            }
            throw new FormatException();
        ...
        /// invalid <see cref="RandomParameters"/> data, or the format cannot be
        /// determined.</exception>
        public static RandomParameters ParseExact(in ReadOnlySpan<char> s, string? format)
        {
            if (s.IsEmpty || s.IsWhiteSpace())
            {
                throw new FormatException();
            }
            if (TryParseExact(s, format, CultureInfo.CurrentCulture, out var result))
            {
                return result;
            }
            throw new FormatException();
        ...
        /// invalid <see cref="RandomParameters"/> data, or the format cannot be
        /// determined.</exception>
        public static RandomParameters ParseExact(string? s, string? format, IFormatProvider? provider)
        {
            if (string.IsNullOrWhiteSpace(s))
            {
                throw new FormatException();
        ...
        /// invalid <see cref="RandomParameters"/> data, or the format cannot be
        /// determined.</exception>
        public static RandomParameters ParseExact(in ReadOnlySpan<char> s, string? format, IFormatProvider? provider)
        {
            if (s.IsEmpty || s.IsWhiteSpace())
            {
                throw new FormatException();
        ...
        /// <remarks>
        /// <para>
        /// The <see cref="TryParse(string?, out RandomParameters)"/> method is similar to the <see
        ...
        public static bool TryParse(string? s, out RandomParameters result)
        {
            ...
            return TryParseMultiple(s, CultureInfo.CurrentCulture, out result);
        }
        ...
        /// <remarks>
        /// <para>
        /// The <see cref="TryParse(in ReadOnlySpan{char}, out RandomParameters)"/> method is
        /// similar to the <see cref="Parse(in ReadOnlySpan{char})"/> method, except that the <see
        /// cref="TryParse(in ReadOnlySpan{char}, out RandomParameters)"/> method does not throw an
        /// exception if the conversion fails.
        /// </para>
        /// </remarks>
        public static bool TryParse(in ReadOnlySpan<char> s, out RandomParameters result)
        {
            result = Default;
        ...
        /// <remarks>
        /// <para>
        /// The <see cref="TryParse(in ReadOnlySpan{char}, IFormatProvider?, out
        /// RandomParameters)"/> method is similar to the <see cref="Parse(in ReadOnlySpan{char},
        /// IFormatProvider)"/> method, except that the <see cref="TryParse(in ReadOnlySpan{char},
        /// IFormatProvider, out RandomParameters)"/> method does not throw an exception if the
        /// conversion fails.
        /// </para>
        /// </remarks>
        public static bool TryParse(in ReadOnlySpan<char> s, IFormatProvider? provider, out RandomParameters result)
        {
            result = Default;
        ...
        /// <remarks>
        /// <para>
        /// The <see cref="TryParseExact(string, string, out RandomParameters)"/> method is similar
        /// to the <see cref="ParseExact(string, string)"/> method, except that the <see
        /// cref="TryParseExact(string, string, out RandomParameters)"/> method does not throw an
        /// exception if the conversion fails.
        /// </para>
        /// <para>
        ...
        public static bool TryParseExact(string? s, string? format, out RandomParameters result)
        {
            ...
            return TryParseExact(s.AsSpan(), format, CultureInfo.CurrentCulture, out result);
        }
        ...
        /// <remarks>
        /// <para>
        /// The <see cref="TryParseExact(in ReadOnlySpan{char}, string?, IFormatProvider?, out
        /// RandomParameters)"/> method is similar to the <see cref="ParseExact(in
        /// ReadOnlySpan{char}, string, IFormatProvider)"/> method, except that the <see
        /// cref="TryParseExact(in ReadOnlySpan{char}, string, IFormatProvider, out
        /// RandomParameters)"/> method does not throw an exception if the conversion fails.
        /// </para>
        /// <para>
        /// Only recognized formats can be parsed successfully. Even recognized formats may not
        ...
        /// </para>
        /// </remarks>
        public static bool TryParseExact(in ReadOnlySpan<char> s, string? format, IFormatProvider? provider, out RandomParameters result)
        {
            result = Default;
        ...
        {
            var hashCode = -1733238069;
            hashCode = (hashCode * -1521134295) + DistributionType.GetHashCode();
            hashCode = (hashCode * -1521134295) + (Maximum.HasValue ? EqualityComparer<double>.Default.GetHashCode(Maximum.Value) : 0);
            hashCode = (hashCode * -1521134295) + (Minimum.HasValue ? EqualityComparer<double>.Default.GetHashCode(Minimum.Value) : 0);
            hashCode = (hashCode * -1521134295) + (Parameters is null ? 0 : EqualityComparer<double[]>.Default.GetHashCode(Parameters));
            return (hashCode * -1521134295) + (Precision.HasValue ? EqualityComparer<byte>.Default.GetHashCode(Precision.Value) : 0);
        }
        ...
        {
            info.AddValue(nameof(DistributionType), DistributionType);
        ...
        public override string ToString() => ToStringGeneral(null);
        ...
        public string ToString(string? format, IFormatProvider? provider = null)
        {
            if (string.IsNullOrWhiteSpace(format)
                || string.Equals(format, "g", StringComparison.OrdinalIgnoreCase))
            {
                return ToStringGeneral(provider);
            }
            else if (string.Equals(format, "r", StringComparison.OrdinalIgnoreCase))
            {
                return ToStringRoundTrip();
            }
            throw new ArgumentException("The provided format is unrecognized", nameof(format));
        }
        ...
        private string ToStringRoundTrip()
        {
