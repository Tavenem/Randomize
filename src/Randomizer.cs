...
namespace Tavenem.Randomize
{
    ...
    public class Randomizer
    {
        ...
        /// name="maxValue"/>.</returns>
        public HugeNumber NextNumber(HugeNumber maxValue) => _generator.NextNumber(maxValue);
        ...
        /// is determined by <see cref="RandomizeOptions.InvalidFloatingRangeResult"/>.
        /// </remarks>
        public HugeNumber NextNumber(HugeNumber minValue, HugeNumber maxValue) => _generator.NextNumber(minValue, maxValue);
        ...
        /// </remarks>
        public Mathematics.Decimals.Quaternion NextQuaternionDecimal()
            => new Mathematics.Decimals.Quaternion(NextDecimal(), NextDecimal(), NextDecimal(), NextDecimal()).Normalize();
        ...
        /// considered to be inconsequential.
        /// </remarks>
        public Mathematics.Doubles.Quaternion NextQuaternionDouble()
            => new Mathematics.Doubles.Quaternion(NextDouble(), NextDouble(), NextDouble(), NextDouble()).Normalize();
        ...
        /// considered to be inconsequential.
        /// </remarks>
        public Mathematics.HugeNumbers.Quaternion NextQuaternionNumber()
            => new Mathematics.HugeNumbers.Quaternion(NextNumber(), NextNumber(), NextNumber(), NextNumber()).Normalize();
        ...
        /// <remarks>
        /// A random rotation is generated with <see cref="NextQuaternionDecimal()"/>, then the
        ...
        /// </remarks>
        public Mathematics.Decimals.Vector3 NextVector3Decimal(decimal maxLength)
            => Mathematics.Decimals.Vector3.UnitX.Transform(NextQuaternionDecimal()) * NextDecimal(maxLength);
        ...
        /// </para>
        /// </remarks>
        public Mathematics.Decimals.Vector3 NextVector3Decimal(decimal minLength, decimal maxLength)
            => Mathematics.Decimals.Vector3.UnitX.Transform(NextQuaternionDecimal()) * NextDecimal(minLength, maxLength);
        ...
        /// the vector components were generated independently.
        /// </remarks>
        public Mathematics.Doubles.Vector3 NextVector3Double(double maxLength)
            => Mathematics.Doubles.Vector3.UnitX.Transform(NextQuaternionDouble()) * NextDouble(maxLength);
        ...
        /// </para>
        /// </remarks>
        public Mathematics.Doubles.Vector3 NextVector3Double(double minLength, double maxLength)
            => Mathematics.Doubles.Vector3.UnitX.Transform(NextQuaternionDouble()) * NextDouble(minLength, maxLength);
        ...
        /// </para>
        /// <para>
        /// <see cref="HugeNumber.PositiveInfinity"/> will always result in an infinite-length
        /// vector.
        /// </para>
        /// </param>
        /// <returns>A randomly oriented vector whose length is between 0 and <paramref
        /// name="maxLength"/>, and whose components are <see cref="HugeNumber"/>
        /// values.</returns>
        /// <remarks>
        /// A random rotation is generated with <see cref="NextQuaternionNumber()"/>, then the
        /// vector is scaled randomly according to <paramref name="maxLength"/>, to avoid
        /// unintentionally generating lengths in a quasi-Gaussian distribution, as would occur if
        /// the vector components were generated independently.
        /// </remarks>
        public Mathematics.HugeNumbers.Vector3 NextVector3Number(HugeNumber maxLength)
            => Mathematics.HugeNumbers.Vector3.UnitX.Transform(NextQuaternionNumber()) * NextNumber(maxLength);
        ...
        /// </para>
        /// </remarks>
        public Mathematics.HugeNumbers.Vector3 NextVector3Number(HugeNumber minLength, HugeNumber maxLength)
            => Mathematics.HugeNumbers.Vector3.UnitX.Transform(NextQuaternionNumber()) * NextNumber(minLength, maxLength);
